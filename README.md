...
- Use the following commands to download contents from remote branches locally, switch to the `development` branch and then, pulling the latest changes from remote repository respectively:
