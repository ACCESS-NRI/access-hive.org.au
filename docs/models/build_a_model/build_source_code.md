...
Before running the model, set up the remote client for _Linaro Forge_ by following the [Connecting remotely](https://docs.linaroforge.com/25.0.2/html/forge/forge/connecting_to_a_remote_system/connecting_remotely.html) instructions. The recommended way to execute a debugging run is by using _payu_ as follows:
