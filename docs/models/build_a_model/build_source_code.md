...
Debugging is an important build of the development process. Using a debugger can make this process significantly easier, allowing detailed inspection of the state of the code as it is running. The debugger used in this guide is Linaro DDT from [Linaro Forge](https://www.linaroforge.com/).
