...
<img src="../../../assets/model-config-logos/configurations-without-titles/access-esm.png" alt="ACCESS ESM model" class="white-background center-img with-border with-padding"></img>
